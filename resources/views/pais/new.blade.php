...
<html lang="en">
  ...
  <div class="container">
    ...
    <form method="POST" action="{{ route('paises.store') }}">
        ...
        <div class="mb-3">
            <label for="capi" class="form-label">Continent</label>
            <input type="text" class="form-control" id="capi" name="capi" aria-describedby="capitHelp"
                placeholder="Continent number">
        </div>
        <div class="mt-3">
